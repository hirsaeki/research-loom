...
class WriterCompositionHistoryService(WriterCompositionService):
    ...
    def _latest_version_info(
        ...
        *,
        ...
        try:
            ...
            raise LocalApplicationError("APPLICATION-WRITER-COMPOSITION-INTEGRITY-001", "composition latest-version index is unreadable") from exc
        ...
        # A crash may occur after an immutable version file is installed but before
        # the small latest-version index is advanced. Recover only that single,
        # exactly chained version; anything broader remains fail-closed.
    ...
    def list(self) -> Mapping[str, Any]:
        ...
        for root in roots[:MAX_LIST_COMPOSITIONS]:
            ...
            if latest_info is None: continue
    ...
    def _legacy_selection(self, composition_id: str) -> Mapping[str, Any] | None:
        ...
        try:
            ...
            raise LocalApplicationError("APPLICATION-WRITER-COMPOSITION-INTEGRITY-001", "composition selection history is unreadable") from exc
    ...
    def _selection_event(self, composition_id: str, sequence: int, package_cache: dict[tuple[str, str], Mapping[str, Any]] | None = None) -> Mapping[str, Any]:
        ...
        try:
            ...
            raise LocalApplicationError("APPLICATION-WRITER-COMPOSITION-INTEGRITY-001", "composition selection event is unreadable") from exc
